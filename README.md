...
* [Fable-Elmish-Electron demo](https://github.com/cmeeren/fable-elmish-electron-demo) - Complete boilerplate for Electron apps using Fable 2 and Elmish with hot module reloading, time-travel debugging, etc.
